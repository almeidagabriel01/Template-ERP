            ...
            <Card className="bg-muted/30 border-dashed">
                <CardHeader className="text-center pb-10 pt-10">
                    ...
                    <CardDescription className="max-w-md mx-auto mt-2">
                        Apenas o administrador da conta ({isMaster ? "Você" : "Master"}) pode gerenciar planos e faturamento.
                        Entre em contato com o responsável se você precisa de alterações.
                    </CardDescription>
                </CardHeader>
            </Card>
        );
        ...
        <div className="space-y-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-muted/40 p-6 rounded-xl border border-border shadow-sm">
                <div className="text-center sm:text-left">
                    <h2 className="text-lg font-semibold tracking-tight">Assinatura & Planos</h2>
                ...
                <div className="flex items-center gap-3">
                    <Link href="/profile/addons">
                        <Button variant="outline" size="sm" className="h-9 bg-background hover:bg-accent hover:text-accent-foreground border-border/50 shadow-sm">
