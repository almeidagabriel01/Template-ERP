...
Use template from `D:/DEV/ProOps/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/DEV/ProOps/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/DEV/ProOps/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
