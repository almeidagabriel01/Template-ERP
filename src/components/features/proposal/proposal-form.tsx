...
export function ProposalForm({ proposalId }: ProposalFormProps) {
  ...
  const [activeView, setActiveView] = React.useState<"edit" | "preview">(
    "edit",
  );
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="clientEmail">Email do Contato</Label>
                  <Input
                    id="clientEmail"
                    name="clientEmail"
                    type="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="grid gap-2">
                  <Label htmlFor="clientPhone">Telefone do Contato</Label>
                  <Input
                    id="clientPhone"
                    name="clientPhone"
