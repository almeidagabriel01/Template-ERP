...
export function FormContainer({ className, children, ...props }: FormContainerProps) {
    return (
        <div
            className={cn(
        ...
        >
            ...
            <div
                className={cn(
                    ...
                    collapsible && "cursor-pointer select-none hover:from-muted/70 transition-colors"
                )}
...
export function FormGroup({ cols = 2, className, children, ...props }: FormGroupProps) {
    const gridCols = {
        1: "grid-cols-1",
    ...
    return (
        <div
            className={cn("grid gap-5", gridCols[cols], className)}
            {...props}
        >
            {children}
        </div>
...
export function FormStatic({ label, value, placeholder = "—" }: FormStaticProps) {
    return (
