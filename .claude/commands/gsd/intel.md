...
Intel system is disabled. To activate:
  ...
  node D:/DEV/ProOps/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/DEV/ProOps/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/DEV/ProOps/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/DEV/ProOps/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
