    ...
    return (
        ...
        `}
          ...
          `}>
                    ...
                    <div className="text-center">
                        <p className={`font-bold text-lg ${type === "income" ? "text-green-600 dark:text-green-400" : "text-foreground"}`}>
                            Receita
                        </p>
        ...
        `}
          ...
          `}>
                    ...
                    <div className="text-center">
                        <p className={`font-bold text-lg ${type === "expense" ? "text-red-600 dark:text-red-400" : "text-foreground"}`}>
                            Despesa
                        </p>
...
export function PaymentSection({ formData, onFormDataChange, onChange }: PaymentSectionProps) {
    return (
        <FormSection
...
export function ClientSection({ clientName, clientId, onClientChange }: ClientSectionProps) {
    return (
        <FormSection
