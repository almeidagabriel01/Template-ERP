        ...
        <>
          ...
          <div className="relative mr-2">
            ...
            >
              <Palette
                className="w-4 h-4"
                style={{ color: textStyle.color || "currentColor" }}
              />
            </Button>
            {showColorPicker && (
              <div
          ...
          <div className="flex items-center border-l pl-2 mr-2">
            ...
            <Button
              variant={
                textStyle.textDecoration === "underline" ? "default" : "ghost"
              }
              size="icon"
              className="h-8 w-8"
              onClick={() =>
        ...
        <>
          ...
          <div className="flex items-center gap-2 mr-2">
            ...
            <input
              ...
              onChange={(e) =>
                updateImageStyle({ width: Number(e.target.value) })
              }
          ...
          <div className="flex items-center border-l pl-2 mr-2">
            ...
            <Button
              variant={
                imageStyle.align === "center" || !imageStyle.align
                  ? "default"
                  : "ghost"
              }
              size="icon"
