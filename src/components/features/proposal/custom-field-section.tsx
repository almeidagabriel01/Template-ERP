...
interface CustomFieldSectionProps {
    ...
    onUpdate: (content: { fieldTypeId?: string; selectedItems?: string[] }) => void
}

export function CustomFieldSection({ content, onUpdate }: CustomFieldSectionProps) {
                ...
                <div className="space-y-2">
                    ...
                    {selectedType.items.length === 0 && (
                        <p className="text-sm text-muted-foreground text-center py-4">
                            Nenhum item cadastrado. Use o botão &quot;Campos Personalizados&quot; para adicionar.
                        </p>
                    )}
                </div>
            )}
