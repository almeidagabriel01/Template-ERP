                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Defina os valores de venda e controle de estoque.</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            <div className="flex items-center justify-between p-2 border rounded-md">
                                ...
                                <span className="text-sm text-green-500 font-bold bg-green-500/10 px-2 py-1 rounded">Ativo</span>
                            </div>
                            <div className="flex items-center justify-between p-2 border rounded-md">
