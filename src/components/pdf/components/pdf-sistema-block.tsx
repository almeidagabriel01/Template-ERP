 ...
 */
export function PdfSistemaBlock({ sistema, products, primaryColor }: PdfSistemaBlockProps) {
    const sistemaSubtotal = products.reduce((sum: number, p: any) => sum + p.total, 0);
