...
```bash
AUDITOR_MODEL=$(node "D:/DEV/ProOps/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/DEV/ProOps/.claude/agents/gsd-eval-auditor.md for instructions.
