...
import { CreateWalletInput, UpdateWalletInput } from "@/services/wallet-service";
import {
    Plus,
...
export default function WalletsPage() {
    ...
    const [filterStatus, setFilterStatus] = React.useState<"active" | "archived" | "all">("active");
    ...
    const handleFormSubmit = async (data: CreateWalletInput | UpdateWalletInput) => {
        if (selectedWallet) {
    ...
    const handleTransferSubmit = async (data: Parameters<typeof transferBalance>[0]) => {
        return await transferBalance(data);
    };
    ...
    const handleConfirmArchive = async () => {
        ...
        setIsArchiving(true);
        const newStatus = selectedWallet.status === 'archived' ? 'active' : 'archived';
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 md:gap-8">
                    <div className="text-center md:text-right">
                        ...
                        <div
                            className={`text-2xl font-bold ${summary.totalBalance >= 0 ? "text-green-500" : "text-red-500"
                                }`}
                        >
